...
Two vanilla JavaScript modules in [public/scripts/](public/scripts/) provide interactions:

- `reveal.js`: Scroll-based reveal animations using IntersectionObserver
- `mouse-parallax.js`: Mouse-tracking parallax effects

These are loaded in [BaseLayout.astro](src/layouts/BaseLayout.astro#L39) as ES modules.

**Reveal animation system** ([global.css](src/styles/global.css) + [reveal.js](public/scripts/reveal.js)):
...
**Completed dynamic detail pages (no further work needed):**
- [blog/[slug].astro](src/pages/blog/[slug].astro): footerVariant="light", CtaThreeSection, MoreBlogSection
- [teams/[slug].astro](src/pages/teams/[slug].astro): footerVariant="light", CtaThreeSection, TeamDetailsSection
- [projects/[slug].astro](src/pages/projects/[slug].astro): footerVariant="light", CtaThreeSection, MoreProjectsSection
- [services/[slug].astro](src/pages/services/[slug].astro): footerVariant="light", CtaThreeSection, MoreServicesSection with currentSlug filtering
