  ...
  items: [
    {
      ...
      skills: [
        ...
        { label: 'Scheduling', value: '92%' },
        { label: 'Budgeting', value: '88%' }
      ]
    },
    {
      name: 'Ella West',
      ...
      skills: [
        { label: 'Structural Engineering', value: '93%' },
        { label: 'Safety', value: '97%' },
        { label: 'Technical Design', value: '91%' },
        { label: 'Quality Control', value: '89%' }
      ]
    },
    {
      name: 'Robin Row',
